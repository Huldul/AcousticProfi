 ...
 <main class="main-page about">
            <div class="main-page__video">
                ...
                <video autoplay muted loop>
                    ...
                    $data = json_decode(html_entity_decode($page->head_video), true);
                ...
                <div class="about-title__group container">
                    <h1>{{$page->head_title}}</h1>
                    <p>{{$page->head_subtitle}}</p>
                </div>
            </div>
            <div class="about-links__group container">
            ...
            <section id="about" class="about-us container">
                ...
                <img src="{{asset("storage/".$page->main_image)}}" alt="">
                {!!$page->main_text!!}
            </section>
            <section id="advantages" class="advantages container">
                <div class="bg-svg">
                    <h2 class="advantages__title about-us__title title">Наши преимущества</h2>
                    <svg class="animated-svg" width="112.000000" height="75.903931" viewBox="0 0 112 75.9039" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <desc>
                                Created with Pixso.
                        </desc>
